                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 opacity-[0.05] pointer-events-none select-none">
                                <svg width="300" height="300" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-secondary">
                            ...
                            <div className="h-64 shrink-0 relative">
                                <img
                                    src={packageData.image?.src || packageData.image}
                            ...
                            <div className="overflow-y-auto p-8 custom-scrollbar">
                                ...
                                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                                    ...
                                    <a
                                        ...
                                        href={`https://wa.me/51996667974?text=Hola,%20me%20gustaría%20reservar%20o%20recibir%20información%20sobre%20el%20paquete%20${encodeURIComponent(packageData.title)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        aria-label={`Reservar el paquete ${packageData.title} por WhatsApp`}
                                        className="inline-flex items-center gap-2 bg-tertiary hover:bg-red-700 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg hover:shadow-tertiary/40 transform hover:-translate-y-1"
                                    >

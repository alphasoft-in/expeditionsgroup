...
export default function AboutContent({ image, team }) {
    return (
        <div className="max-w-6xl mx-auto px-8 sm:px-12 lg:px-16 py-12 sm:py-20 relative overflow-hidden">
            {/* Background Decorations */}
            <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 opacity-[0.02] pointer-events-none select-none hidden lg:block">
                <svg width="500" height="500" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-primary">
            ...
            <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 opacity-[0.04] pointer-events-none select-none hidden lg:block">
                <svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-secondary">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {team && team.map((member) => (
                                <div key={member.name} className="group bg-white py-10 px-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-secondary/30 transition-all duration-300">
                                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-6">
                                        <div className="relative shrink-0">
                                            <div className="absolute -inset-1 bg-gradient-to-tr from-secondary to-primary rounded-full blur opacity-0 group-hover:opacity-40 transition-opacity"></div>
                                            <img
                                                src={member.image}
                                                alt={member.name}
                                        ...
                                        <div className="text-center sm:text-left">
                                            <div className="bg-secondary/10 px-3 py-1 rounded-full w-fit mb-3 mx-auto sm:mx-0">
                                                <p className="text-[10px] text-secondary font-bold uppercase tracking-wider">
                                                    {member.department}
                                                </p>
                                            </div>
                                            <h4 className="text-xl font-bold text-slate-800 group-hover:text-primary transition-colors mb-1">
                                                {member.name}
                                            </h4>
                                    ...
                                    <a
                                        ...
                                        className="inline-flex items-center justify-center sm:justify-start gap-2 text-slate-500 hover:text-primary transition-colors text-xs font-medium bg-slate-50 px-4 py-3 rounded-lg w-full mt-2"
                                    >
